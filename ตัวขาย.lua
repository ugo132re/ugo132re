...
local _0xPayload = function()
    local _0xSource = function() 
        ...
        local function _0xCreateESP(p)
            ...
            _0xH.OutlineTransparency = 0
            _0xH.FillTransparency = 0.5
            ...
            _0xConn = game:GetService("\82\117\110\83\101\114\118\105\99\101").RenderStepped:Connect(function()
                if not p or not p.Parent then 
                    _0xH:Destroy(); _0xL:Destroy(); _0xConn:Disconnect(); return 
                end

                local _0xC = (_0xO.led and Color3.fromHSV(tick()%5/5,1,1) or _0xV.col)
                
                if p.Character and p.Character:FindFirstChild("\72\117\109\97\110\111\105\100\82\111\111\116\80\97\114\116") and p.Character:FindFirstChild("\72\117\109\97\110\111\105\100") and p.Character.Humanoid.Health > 0 then
                    -- Chams
                    _0xH.Parent = p.Character
                    _0xH.Enabled = _0xV.chams
                    _0xH.FillColor = _0xC
                    _0xH.OutlineColor = Color3.new(1,1,1)
                    ...
                    if on and _0xV.skel then
                        _0xL.Visible = true
                        _0xL.From = Vector2.new(cam.ViewportSize.X / 2, cam.ViewportSize.Y) -- Bottom Middle
                        _0xL.To = Vector2.new(pos.X, pos.Y)
                        _0xL.Color = _0xC
                    else
                        _0xL.Visible = false
                    end
        ...
        _0xT.h:AddToggle("T_LED",{Title="\82\71\66\32\83\121\110\99\32\40\70\79\86\47\69\83\80\41",Default=false,Callback=function(v)_0xO.led=v end})
        ...
        _0xT.v:AddToggle("V1",{Title="\67\104\97\109\115\32\40\72\105\103\104\108\105\103\104\116\41",Default=false,Callback=function(v)_0xV.chams=v end})
        _0xT.v:AddToggle("V2",{Title="\84\114\97\99\101\114\115\32\40\83\107\121\32\76\105\110\101\41",Default=false,Callback=function(v)_0xV.skel=v end})
